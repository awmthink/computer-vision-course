...
![剪枝](https://huggingface.co/datasets/hf-vision/course-assets/resolve/main/pruning.png)
...
![知识蒸馏](https://huggingface.co/datasets/hf-vision/course-assets/resolve/main/knowledge_distillation.png)
...
![模型大小与准确性](https://huggingface.co/datasets/hf-vision/course-assets/resolve/main/model_size_vs_accuracy.png)

![准确性与延迟](https://huggingface.co/datasets/hf-vision/course-assets/resolve/main/accuracy_vs_latency.png)
