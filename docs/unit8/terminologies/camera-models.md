...
![Blender相机坐标轴约定](https://huggingface.co/datasets/hf-vision/course-assets/resolve/main/axes_handedness.png)
相机坐标轴的方向有多种不同的约定。这里我们遵循Blender的约定（见图），相机指向负Z轴，相机的X轴指向左侧（从相机看），相机的Y轴指向上方。

### 针孔相机坐标变换

![针孔变换](https://huggingface.co/datasets/hf-vision/course-assets/resolve/main/Pinhole_transform.png)
